...
export const BACKGROUND_PRESETS: BackgroundPreset[] = [
  ...
  },
  {
    ...
    fabricValue: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)',
  },
  {
    id: 'aurora',
    label: 'Aurora',
...
export const ASPECT_RATIO_PRESETS: AspectRatioPreset[] = [
  { id: 'free', label: 'Free', description: 'No constraint', width: 0, height: 0 },
  { id: '1:1', label: '1 : 1', description: 'Square / Instagram', width: 1, height: 1 },
  { id: '16:9', label: '16 : 9', description: 'Widescreen / YouTube', width: 16, height: 9 },
  { id: '4:3', label: '4 : 3', description: 'Classic', width: 4, height: 3 },
  { id: '3:2', label: '3 : 2', description: 'Photography', width: 3, height: 2 },
  { id: '2:1', label: '2 : 1', description: 'Twitter card', width: 2, height: 1 },
  { id: '9:16', label: '9 : 16', description: 'Stories / TikTok', width: 9, height: 16 },
]
